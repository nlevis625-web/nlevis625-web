(function () {
  ...
  if (!isDesktop()) {
    ...
    document.body.innerHTML =
      ...
      '<div style="max-width:420px;background:#fff;border:1px solid #e5e7eb;border-top:4px solid #E2001A;border-radius:12px;padding:28px;text-align:center;box-shadow:0 8px 24px rgba(0,0,0,.08)">' +
      '<h1 style="font-size:20px;margin-bottom:12px;color:#E2001A">Ordinateur requis</h1>' +
